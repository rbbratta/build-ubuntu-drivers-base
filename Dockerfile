...
# -L for redirects
RUN curl -sS -L -o ixgbe-4.4.6.tar.gz 'http://downloads.sourceforge.net/project/e1000/ixgbe%20stable/4.4.6/ixgbe-4.4.6.tar.gz?use_mirror=heanet'  && tar -xvf ixgbe-4.4.6.tar.gz && rm ixgbe-4.4.6.tar.gz
RUN curl -sS -L -o i40e-1.5.19.tar.gz 'http://downloads.sourceforge.net/project/e1000/i40e%20stable/1.5.19/i40e-1.5.19.tar.gz?use_mirror=heanet'  && tar -xvf i40e-1.5.19.tar.gz && rm i40e-1.5.19.tar.gz
